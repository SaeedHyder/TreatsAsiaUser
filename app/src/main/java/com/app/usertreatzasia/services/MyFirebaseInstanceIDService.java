...
import com.app.usertreatzasia.helpers.TokenUpdater;
...
//        TokenUpdater.getInstance().UpdateToken(getApplicationContext(), token + "", AppConstants.Device_Type, preferenceHelper.getSignUpUser().getToken(),preferenceHelper);
    }
