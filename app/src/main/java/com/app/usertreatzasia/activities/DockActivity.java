...
import com.app.usertreatzasia.fragments.HomeFragment;
...
public abstract class DockActivity extends AppCompatActivity implements
    ...
    public SimpleSideMenuFragment simpleSideMenuFragment;
    ...
    public void emptyBackStack() {
        ...
        for (int i = 0; i < getSupportFragmentManager().getBackStackEntryCount(); i++) {
            ...
            if (entry != null && (!(entry instanceof HomeFragment)) && (!(entry instanceof SimpleSideMenuFragment))) {
