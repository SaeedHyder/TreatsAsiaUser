...
public class SignupEntitiesChanged {
    ...
    @SerializedName("totalcreditearned")
    @Expose
    private String totalcreditearned;
    @SerializedName("totalcreditused")
    @Expose
    private String totalcreditused;
    @SerializedName("totalpointearned")
    @Expose
    private String totalpointearned;
    @SerializedName("totalpointused")
    @Expose
    private String totalpointused;
    @SerializedName("profile_image")
    @Expose
    private String profileImage;
    @SerializedName("gettotalmember")
    @Expose
    private String gettotalmember;
    @SerializedName("getevoucher")
    @Expose
    private String getevoucher;
    ...
    public String getTotalcreditearned() {
        return totalcreditearned;
    }

    public void setTotalcreditearned(String totalcreditearned) {
    ...
    public String getTotalpointearned() {
        return totalpointearned;
    }

    public void setTotalpointearned(String totalpointearned) {
        this.totalpointearned = totalpointearned;
    }

    public String getTotalpointused() {
        return totalpointused;
    }

    public void setTotalpointused(String totalpointused) {
    ...
    public String getGettotalmember() {
        return gettotalmember;
    }

    public void setGettotalmember(String gettotalmember) {
        this.gettotalmember = gettotalmember;
    }

    public String getGetevoucher() {
        return getevoucher;
    }

    public void setGetevoucher(String getevoucher) {
        this.getevoucher = getevoucher;
    }
}
