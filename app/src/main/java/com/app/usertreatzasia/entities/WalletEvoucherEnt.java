...
import com.app.usertreatzasia.entities.EvoucherDetail;
import com.google.gson.annotations.Expose;
import com.google.gson.annotations.SerializedName;

public class WalletEvoucherEnt {
    ...
    @Expose
    private EvoucherDetailWallet evoucherDetail;
    @SerializedName("user_detail")
    @Expose
    private UserDetailWallet userDetail;
    ...
    public EvoucherDetailWallet getEvoucherDetail() {
        return evoucherDetail;
    }

    public void setEvoucherDetail(EvoucherDetailWallet evoucherDetail) {
        this.evoucherDetail = evoucherDetail;
    }

    public UserDetailWallet getUserDetail() {
        return userDetail;
    }

    public void setUserDetail(UserDetailWallet userDetail) {
