...
public class RedemptionEnt {
    ...
    @Expose
    private EvoucherDetailRedemption evoucherDetail;
    ...
    public EvoucherDetailRedemption getEvoucherDetail() {
        return evoucherDetail;
    }

    public void setEvoucherDetail(EvoucherDetailRedemption evoucherDetail) {
